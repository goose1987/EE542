...
#define Counter_2_INIT_COUNTER_VALUE      255u
#if (Counter_2_UsingFixedFunction)
 ...
 *************************************/
    ...
    ********************************/
    ...
    #define Counter_2_CONTROL              (* (reg8 *) Counter_2_CounterUDB_sCTRLReg_AsyncCtl_ctrlreg__CONTROL_REG )
    #define Counter_2_CONTROL_PTR          (  (reg8 *) Counter_2_CounterUDB_sCTRLReg_AsyncCtl_ctrlreg__CONTROL_REG )
