...
# Date: Mon, 08 Dec 2014 22:01:21 GMT
#set_units -time ns
create_clock -name {ADC_DelSig_V_Ext_CP_Clk(routed)} -period 416.66666666666663 -waveform {0 208.333333333333} [list [get_pins {ClockBlock/dclk_1}]]
...
create_generated_clock -name {ADC_DelSig_V_Ext_CP_Clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 21 41} -nominal_period 416.66666666666663 [list [get_pins {ClockBlock/dclk_glb_1}]]
...
create_generated_clock -name {ADC_DelSig_V_theACLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 81 161} -nominal_period 1666.6666666666665 [list [get_pins {ClockBlock/aclk_glb_0}]]
create_clock -name {ADC_DelSig_V_theACLK(fixed-function)} -period 1666.6666666666665 -waveform {0 833.333333333333} [get_pins {ClockBlock/aclk_glb_ff_0}]
...
# Project: C:\Users\hoangp\Documents\GitHub\EE542\firmware\invert\invert.cydsn\invert.cyprj
# Date: Mon, 08 Dec 2014 22:01:02 GMT
