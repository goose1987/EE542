...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("da25746e-e48b-46f1-96ff-84c6ef6c203e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    ADC_DelSig_v2_30_3 ADC_DelSig_1 (
        .vplus(Net_152),
        .vminus(Net_153),
        .soc(1'b1),
        .eoc(Net_186),
