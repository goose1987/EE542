...
module top ;
    ...
    UART_v2_30_9 UART_1 (
        ...
        .reset(Net_313),
        .rx(1'b0),
        .tx_interrupt(Net_326),
        .rx_interrupt(Net_327),
        .tx_data(Net_328),
        .tx_clk(Net_329),
        .rx_data(Net_330),
        .rx_clk(Net_331));
